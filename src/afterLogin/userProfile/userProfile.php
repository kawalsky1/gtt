...
<!-- 
    TO DO:
            We need to create the connection with the db to get the info 
            relative to the user and subsequently the update of the information of the users if updated.
-->
